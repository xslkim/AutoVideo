...
## Corpus Check
- 217 files · ~190,045 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1979 nodes · 3376 edges · 133 communities (112 shown, 21 thin omitted)
- Extraction: 98% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 50 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a5a3de8a`
...
Cohesion: 0.14
Nodes (18): GenerateImageOptions, build(), buildCommand(), BuildError, BuildOptions, CompileOptions, CompileResult, RenderResult (+10 more)
...
Cohesion: 0.10
Nodes (43): createSystemRoutes(), publicConfig(), applyDefined(), configFilePath(), loadStoredConfig(), mergeFields(), mergeStoredConfig(), resolveTaskConfig() (+35 more)
...
Cohesion: 0.11
Nodes (24): assetPaths, buildExtensions(), conflictEtag, conflictVisible, editorEl, emit, handleColorSchemeChange(), isDirty (+16 more)
...
### Community 17 - "tts.ts"
Cohesion: 0.10
Nodes (22): md5File(), tts(), TtsError, TtsOptions, concatenateWavsWithGaps(), ConcatOptions, ff(), getWavDurationSec() (+14 more)

### Community 18 - "HomePage.vue"
Cohesion: 0.09
Nodes (17): createForm, createRules, creating, deleting, deletingProject, demoCreating, doDelete(), formRef (+9 more)

### Community 19 - "AssetManager.vue"
Cohesion: 0.10
Nodes (16): AssetFile, assets, dialog, errorMsg, fileInputRef, isDragOver, loading, message (+8 more)
...
Cohesion: 0.10
Nodes (23): addBlock(), addingBlock, apiBlocks, batchClearCache(), batchCreate(), batchForce, batchLoading, checkedIds (+15 more)
...
Cohesion: 0.11
Nodes (24): overwrite(), buildExtensions(), conflictData, ConflictInfo, conflictVisible, editorEl, emit, handleColorSchemeChange() (+16 more)

### Community 34 - "image-gen.ts"
Cohesion: 0.06
Nodes (45): ASPECT_TO_SIZE, buildImageKey(), buildWrapperComponent(), cacheModel(), createFetchController(), fetchOpenAIImage(), fetchRemoteImage(), fetchSenseNovaImage() (+37 more)

### Community 35 - "VoxcpmProvider"
Cohesion: 0.10
Nodes (8): computeVoxcpmModelVersion(), TtsProvider, VoxcpmProvider, SpeakOptions, VoxcpmClient, VoxcpmClientOptions, ensureVoxcpmServer(), VoxcpmServerOptions
...
Cohesion: 0.33
Nodes (8): expandCompound(), formatPronunciationLint(), lintPronunciation(), ruleMatchesTerm(), spellOut(), splitCamel(), suggestReading(), applyPronunciation()
...
Cohesion: 0.13
Nodes (21): BuildResult, generateRenderRoot(), RootRenderOptions, AnimationProps, ASPECT_RATIOS, assertVisualsReady(), AudioReadyScript, BlockFrameProps (+13 more)
...
Cohesion: 0.14
Nodes (18): assertNoHtmlMarkerLines(), compile(), loadSchema(), parseMetaArgs(), dictSuggestCommand(), DictSuggestOptions, FontScaleResult, MIN_FONT_COEFF (+10 more)
...
### Community 69 - "render.test.ts"
Cohesion: 0.21
Nodes (7): DEFAULT_CONFIG, applyLoudnorm(), execAsync(), LoudnormConfig, LoudnormResult, MeasuredValues, parseMeasuredValues()
...
### Community 78 - "concat.ts"
Cohesion: 0.24
Nodes (6): ConcatOptions, ConcatResult, probeVideoStreams(), StreamInfo, validatePartials(), ffmpegAvailable
...
Cohesion: 0.09
Nodes (23): copyRemotionFiles(), ensurePublicScript(), findAvailablePort(), generatePreviewRootForBuild(), preview(), PreviewError, PreviewOptions, PreviewResult (+15 more)
...
Cohesion: 0.08
Nodes (35): PartialKey, RenderOptions, AgentProviderName, AgentReviewConfig, AnthropicConfig, AutoVideoConfig, CacheConfig, DEFAULT_HTML_RENDER (+27 more)
...
### Community 107 - "uploadFiles"
Cohesion: 0.40
Nodes (5): fetchAssets(), onDeleteAsset(), onDrop(), onFileInput(), uploadFiles()
